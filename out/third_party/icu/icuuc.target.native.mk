...
TOOLSET := target
TARGET := icuuc
DEFS_Debug := '-DU_USING_ICU_NAMESPACE=0' \
	'-DHAVE_DLOPEN=0' \
...
INCS_Debug := -I$(srcdir)/third_party/icu/source/common \
	-I$(srcdir)/third_party/icu/source/i18n

DEFS_Optdebug := '-DU_USING_ICU_NAMESPACE=0' \
	'-DHAVE_DLOPEN=0' \
	'-DUCONFIG_NO_NON_HTML5_CONVERSION=1' \
	'-DV8_TARGET_ARCH_X64' \
	'-DU_COMMON_IMPLEMENTATION' \
...
INCS_Optdebug := -I$(srcdir)/third_party/icu/source/common \
	-I$(srcdir)/third_party/icu/source/i18n

DEFS_Release := '-DU_USING_ICU_NAMESPACE=0' \
	'-DHAVE_DLOPEN=0' \
	'-DUCONFIG_NO_NON_HTML5_CONVERSION=1' \
	'-DV8_TARGET_ARCH_X64' \
	'-DU_COMMON_IMPLEMENTATION' \
...
INCS_Release := -I$(srcdir)/third_party/icu/source/common \
	-I$(srcdir)/third_party/icu/source/i18n

OBJS := $(obj).target/$(TARGET)/third_party/icu/source/common/appendable.o \
